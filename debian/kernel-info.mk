...
DEVICE_FULL_NAME = Xiaomi Redmi 9C
...
KERNEL_CONFIG_EXTRA_FRAGMENTS = droidian.config halium.config angelica.config
...
# will be made.
KERNEL_IMAGE_DTB = arch/arm64/boot/dts/mediatek/dandelion.dtb arch/arm64/boot/dts/mediatek/mt6765.dtb
...
# Header v2 also uses the tags offset for the DTB address
KERNEL_BOOTIMAGE_DTB_OFFSET = 0x07808000

# --- Command Line ---
# Cleaned up (removed extra whitespace and buildvariant)
KERNEL_BOOTIMAGE_CMDLINE = bootopt=64S3,32N2,64N2 console=tty0 droidian.lvm.prefer
# Specify boot image security patch level if needed
KERNEL_BOOTIMAGE_PATCH_LEVEL = 2022-07-01
...
# Device manufacturer (ro.product.vendor.manufacturer)
FLASH_INFO_MANUFACTURER = xiaomi

# Device model (ro.product.vendor.model)
# Note: For angelica, it is often just 'Redmi 9C'
FLASH_INFO_MODEL = Redmi 9C

# Device CPU (Grep string for /proc/cpuinfo)
# On MT6765 devices, this string is unique to the Helio G35
FLASH_INFO_CPU = MT6765G

# Space-separated list of fastboot IDs
# 'angelica' is the standard; 'angelican' is the NFC variant
FLASH_INFO_DEVICE_IDS = angelica
